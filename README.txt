Script for solving large models from MUIO
===============================================
...
2. Create the required conda environment using the provided otoole.yml file:
...
Arguments
---------
<input_file> : The .txt data file generated from MUIO (OSeMOSYS user interface). This file contains the model data.
Example: data.txt

<solver> : The solver to use for optimization. Must be one of: cplex, gurobi, glpk, cbc.
Example: gurobi
